...
- `.github/workflows/openwiki-update.yml` — scheduled/manual OpenWiki refresh workflow that now runs on `workflow_dispatch` plus a daily cron and publishes OpenWiki updates with OpenRouter/LangSmith tracing configuration.
