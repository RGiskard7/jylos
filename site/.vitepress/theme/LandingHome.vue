      ...
      <div class="landing-container download-inner">
        ...
        <div class="download-grid">
          <div v-for="platform in t.downloadPlatforms" :key="platform.platform" class="download-card">
            ...
            <template v-else>
              <img class="download-icon download-icon-linux linux-dark" src="https://cdn.simpleicons.org/linux/8ea0ff" alt="Linux" />
              <img class="download-icon download-icon-linux linux-light" src="https://cdn.simpleicons.org/linux/5563d6" alt="" aria-hidden="true" />
            </template>
